...
var config = {
  ...
  var mainApp = firebase.initializeApp({
    ...
    "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/jergus-app-todo%40appspot.gserviceaccount.com"
    }
  });
...
nameRef.root.child('filipjerga/age').remove().then(()=> {
  console.log('removed');
}, (e) => {
    console.log('Not removed');
});

nameRef.root.child('isRunnig').remove().then(()=> {
  console.log('removed');
}, (e) => {
  console.log('error');
});
